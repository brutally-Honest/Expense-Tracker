 ...
 *
 * @param {string[]} categories — from GET /api/categories (options after "All")
 */
export function FilterBar({ categories = [], filters, onFilterChange }) {
  const withAll = ['', ...categories];
  return (
    <div className="flex flex-wrap gap-3 items-center">
      ...
      <div className="flex items-center gap-2">
        ...
        <select
          value={categories.length ? filters.category : ''}
